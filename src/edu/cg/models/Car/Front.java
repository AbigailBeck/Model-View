...
public class Front implements IRenderable, IIntersectable {
	...
	public void render(GL2 gl) {
		...
		wheels.render(gl);
		// Render the bumber.
		gl.glTranslated(Specification.F_HOOD_LENGTH / 2.0 - 1.75 * Specification.F_BUMPER_LENGTH, 0, 0);
		bumber.render(gl);
		gl.glPopMatrix();
	}
	...
	public List<BoundingSphere> getBoundingSpheres() {
		...
		double radius = Specification.F_LENGTH/1.8;
		BoundingSphere s2 = new BoundingSphere(radius, center);
		s2.setSphereColore3d(255,0,0);
		res.add(s2);
		return res;
